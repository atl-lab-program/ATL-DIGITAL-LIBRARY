<?php
/**
 * SVG Vector Icon Registry Helper
 * Replaces all text emojis with clean, scalable SVG vector icons.
 */

function get_icon($name, $class = 'icon-svg', $size = 20) {
    $strokeWidth = 2;
    $icons = [
        ...
        'school' => '<path d="m4 6 8-4 8 4v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Z"/><path d="M12 22v-6"/><path d="M12 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>',
    ...
    return sprintf(
        '<svg class="%s" width="%d" height="%d" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="%s" stroke-linecap="round" stroke-linejoin="round">%s</svg>',
